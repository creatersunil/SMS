...
export class UpcomingEventsComponent implements OnInit {
  ...
  constructor(private m_dbService: DbService, private m_router: Router, private m_log: Logs) { }
  ...
  loadEvents() {
    ...
    filter.set('fields', 'row_Id,event_Name,event_Description,created_Date,start_Date,end_Date,status_Track,created_By_ID,event_Type');
    this.m_dbService.query('event_table', '', filter).subscribe((result) => {
      var data: any = result.json();
